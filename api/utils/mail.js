...
export const sentMail = async ({name,to,subject,msg,Link}) => {
  const transporter = nodemailer.createTransport({
    host: "smtp.gmail.com",
    port: 587,
    auth: {
      user: "sabbir420ar@gmail.com",
      pass: "bmujxxzscbkegtxl",
    },
  });

  //   email content
  await transporter.sendMail({
    from: "Digitic <noreply@example.com>",
    to,
    subject,
    html: `
  ...
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
    ...
    <tr>
      <td bgcolor="#ffffff" style="border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
        ...
        <a href=${Link} style="display: inline-block; background-color: #007BFF; color: #fff; padding: 10px 20px; border-radius: 5px; text-decoration: none; margin-top: 20px;">Verify Account</a>
